            ...
            <div class="card-header flex-wrap py-5">
                <div class="card-title">
                    <h3 class="card-label">All Brands
                        <span class="d-block text-muted pt-2 font-size-sm">all brnds details is here</span></h3>
                </div>
                        ...
                        <tr v-for="(brand, i) in brands">
                            ...
                            <td>
                                <span class="symbol-label">
                                     <img :src="`${brand.photo}`" style="width: 130px; height: 35px;">
                                </span>
                            </td>
                            <td>{{ brand.title }}</td>
                            <td>
                                <router-link :to="{name:'EditBrand', params:{id:brand.id} }" class="btn btn-sm btn-clean btn-icon" title="Edit details">
	                            <span class="svg-icon svg-icon-md">
	                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
	                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
	                                        <rect x="0" y="0" width="24" height="24"/>
                                ...
                                <a href="javascript:;" @click="deleteBrand(brand.id)" class="btn btn-sm btn-clean btn-icon" title="Delete">
	                            <span class="svg-icon svg-icon-md">
	                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
	                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
	                                        <rect x="0" y="0" width="24" height="24"/>
