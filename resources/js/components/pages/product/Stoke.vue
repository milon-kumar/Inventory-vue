                ...
                <table class="table table-separate table-head-custom table-checkable" id="">
                    ...
                    <tr>
                        ...
                        <tr v-for="(product, i) in products">
                            ...
                            <td v-if="product.stock >= 1"><span  class="badge badge-success">Available In Stoke</span></td>
                            <td v-else="" ><span class="badge badge-danger">Out Of Stoke</span></td>
                            <td>{{ product.stock }}</td>
                            <td>
                                <router-link :to="{name:'EditProduct', params:{id:product.id} }" class="btn btn-sm btn-clean btn-icon" title="Edit details">
	                            <span class="svg-icon svg-icon-md">
	                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
	                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
	                                        <rect x="0" y="0" width="24" height="24"/>
